...
`const home = {
    label: "Home",
    title: "Ruth Sada Mwatelah Portfolio",
    description: "Portfolio website showcasing my research as an Epidemiologist",
    headline: <>Advancing global health through data</>,
    subline: (
      <>
        I'm Ruth, a Postdoctoral Researcher @ McGill University investigating
        <br /> microbiome contributions to disease.
      </>
    ),
};`,
    language: "tsx",
